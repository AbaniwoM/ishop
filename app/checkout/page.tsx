...
export default function CheckoutPage() {
    ...
    <div className="container mx-auto px-4 py-8">
        ...
        <form action={checkoutAction} className="max-w-md mx-auto">
            ...
            <Button type="submit" variant="default" className="w-full cursor-pointer">Proceed to Payment</Button>
            <Button onClick={() => clearCart()} variant="default" className="w-full mt-3 bg-red-600 hover:bg-red-500 cursor-pointer">Clear Cart</Button>
        </form>
    </div>
    );
}